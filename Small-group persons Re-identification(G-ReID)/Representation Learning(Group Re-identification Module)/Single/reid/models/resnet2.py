...
#from .shallow_rga import ShallowRGA
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, class_num=1000, last_stride=2, is_for_test=False, norm=False):
        ...
        ##CAM
        self.shallow_pam = ShallowPAM(256)
        #self.shallow_rga = ShallowRGA(256, (256//4)*(128//4), use_spatial=True, use_channel=False,cha_ratio=8, spa_ratio=8, down_ratio=8)
