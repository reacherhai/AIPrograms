...
if __name__ == '__main__':
    ...
    # optimizer
    parser.add_argument('--lr', type=float, default=0.0001, # 0.00001 and 0.0001
    ...
    parser.add_argument('--epochs', type=int, default=3) ##35 and 3
    ...
    parser.add_argument('--trainer', type=int, default=1,help="0-none,1-concate,2-triplet")
    #  perform re-ranking
